...
for size_label, nurses, days in problem_sizes:
    ...
    plt.tight_layout()
    plt.savefig(f'{size_label}_mean_score_SAEXP.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'{size_label}_mean_time_SAEXP.png')
    plt.close()
